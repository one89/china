              ...
              <div class="row align-items-center mb-120">
                 <div class="col-lg-7">
                     <div class="about__img__box mb-60">
                        <img class="about-main-thumb pl-110" src="{{ URL::asset('assets/img/slider/01.png') }}" alt="about-img">
                        <img class="about-img about_01" src="{{ URL::asset('assets/img/about/01.png') }}" alt="about-img">
                        <img class="about-img about_02" src="{{ URL::asset('assets/img/about/02.png') }}" alt="about-img">
                        <img class="about-img about_03" src="{{ URL::asset('assets/img/slider/earth-bg.svg') }}" alt="about-img">
                    </div>
                 </div>
                 <div class="col-lg-5">
