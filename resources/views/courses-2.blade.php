           ...
           <div class="row">
            ...
            <div class="grid row">
                <div class="col-lg-4 col-md-6 grid-item cat2 cat3">
                    <div class="z-gallery z-gallery-two gallery-03 mb-30">
                        <div class="z-gallery__thumb mb-20">
                            <a href="course-details"><img class="img-fluid" src="{{ URL::asset('assets/img/course/13.jpg') }}" alt=""></a>
                ...
                <div class="col-lg-4 col-md-6 grid-item cat1 cat2">
                    <div class="z-gallery z-gallery-two gallery-03 mb-30">
                        <div class="z-gallery__thumb mb-20">
                            <a href="course-details"><img class="img-fluid" src="{{ URL::asset('assets/img/course/14.jpg') }}" alt=""></a>
                            <div class="heart-icon"><i class="fas fa-heart"></i></div>
                            <div class="research-tag">
                                <span>Research</span>
                                <span>Tag</span>
                ...
                <div class="col-lg-4 col-md-6 grid-item cat2">
                    <div class="z-gallery z-gallery-two gallery-03 mb-30">
                        <div class="z-gallery__thumb mb-20">
                            <a href="course-details"><img class="img-fluid" src="{{ URL::asset('assets/img/course/15.jpg') }}" alt=""></a>
                            <div class="heart-icon"><i class="fas fa-heart"></i></div>
                            <div class="research-tag">
                                <span>Research</span>
                                <span>Tag</span>
                ...
                <div class="col-lg-4 col-md-6 grid-item cat1">
                    <div class="z-gallery z-gallery-two gallery-03 mb-30">
                        <div class="z-gallery__thumb mb-20">
                            <a href="course-details"><img class="img-fluid" src="{{ URL::asset('assets/img/course/16.jpg') }}" alt=""></a>
                            <div class="heart-icon"><i class="fas fa-heart"></i></div>
                            <div class="research-tag">
                                <span>Research</span>
                                <span>Tag</span>
                ...
                <div class="col-lg-4 col-md-6 grid-item cat3">
                    <div class="z-gallery z-gallery-two gallery-03 mb-30">
                        <div class="z-gallery__thumb mb-20">
                            <a href="course-details"><img class="img-fluid" src="{{ URL::asset('assets/img/course/17.jpg') }}" alt=""></a>
                            <div class="heart-icon"><i class="fas fa-heart"></i></div>
                            <div class="research-tag">
                                <span>Research</span>
                                <span>Tag</span>
                ...
                <div class="col-lg-4 col-md-6 grid-item cat2 cat1">
                    <div class="z-gallery z-gallery-two gallery-03 mb-30">
                        <div class="z-gallery__thumb mb-20">
                            <a href="course-details"><img class="img-fluid" src="{{ URL::asset('assets/img/course/18.jpg') }}" alt=""></a>
                            <div class="heart-icon"><i class="fas fa-heart"></i></div>
                            <div class="research-tag">
                                <span>Research</span>
                                <span>Tag</span>
