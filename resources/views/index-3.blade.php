            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                        <div class="col-xl-2 col-lg-2 col-5">
                            <div class="logo"><a href="index"><img src="assets/img/logo/header_logo_one.svg" alt=""></a></div>
                        </div>
                                    ...
                                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                        <ul class="navbar-nav">
                                            <li class="nav-item dropdown mega-menu">
                                                ...
                                                <li><a href="index"><span><img src="assets/img/icon/icon7.svg" alt=""></span> Business</a></li>
                                                <li><a href="index-2"><span><img src="assets/img/icon/icon8.svg" alt=""></span> Technology</a></li>
                                                <li><a href="index"><span><img src="assets/img/icon/icon9.svg" alt=""></span> Development</a></li>
                                                <li><a href="index-2"><span><img src="assets/img/icon/icon10.svg" alt=""></span> Photography</a></li>
                                                <li><a href="index"><span><img src="assets/img/icon/icon11.svg" alt=""></span> Digital Marketing</a></li>
                                                <li><a href="index-2"><span><img src="assets/img/icon/icon12.svg" alt=""></span> Programming</a></li>
                                                <li><a href="index"><span><img src="assets/img/icon/icon14.svg" alt=""></span> Videograpgy</a></li>
                                                <li><a href="index-2"><span><img src="assets/img/icon/icon13.svg" alt=""></span> Illustration</a></li>
                                            </ul>
                                            </li>
                        ...
                        <div class="right-nav d-flex align-items-center justify-content-end">
                            <div class="right-btn mr-25 mr-xs-15">
                                <ul class="d-flex align-items-center">
                                    ...
                                    <li><a class="sign-in ml-20" href="login"><img src="assets/img/icon/user.svg" alt=""></a></li>
                                </ul>
                            </div>
         ...
         <nav class="side-mobile-menu">
            <ul id="mobile-menu-active">
                ...
                <li class="has-dropdown">
                    <a href="#">Pages</a>
                    <ul class="sub-menu">
                        <li><a href="courses">Course One</a></li>
                        <li><a href="courses-2">Course Two</a></li>
                        <li><a href="course-details">Courses Details</a></li>
               ...
               <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-5 gx-4 online__course__cat">
                    <div class="col">
                        <div class="courses_link mb-30 wow fadeInUp2 animated" data-wow-delay='.1s'>
                            ...
                            <a href="courses"><img class='arrows-icon' src="assets/img/icon/arrow-right.svg" alt="arrow-right"></a>
                        </div>
                    </div>
                    <div class="col">
        ...
        <div class="container">
            ...
            <div class="grid row">
                <div class="col-lg-4 col-md-6 grid-item cat2 cat3">
                    <div class="z-gallery z-gallery-two gallery-03 mb-30">
                        <div class="z-gallery__thumb mb-20">
                            <a href="course-details"><img class="img-fluid" src="assets/img/course/13.jpg" alt=""></a>
                        ...
                        <div class="z-gallery__content pos-rel">
                            ...
                            <h4 class="sub-title mb-15"><a href="course-details">Take Your Career to the Next Level Future</a></h4>
                            ...
                            <div class="feedback-tag pt-20">
                                ...
                                <a href="course-details" class="read_more float-end">Learn More+</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 grid-item cat1 cat2">
                    <div class="z-gallery z-gallery-two gallery-03 mb-30">
                        <div class="z-gallery__thumb mb-20">
                            <a href="course-details"><img class="img-fluid" src="assets/img/course/14.jpg" alt=""></a>
                            <div class="heart-icon"><i class="fas fa-heart"></i></div>
                            <div class="research-tag">
                                <span>Research</span>
                                <span>Tag</span>
                ...
                <div class="col-lg-4 col-md-6 grid-item cat2">
                    <div class="z-gallery z-gallery-two gallery-03 mb-30">
                        <div class="z-gallery__thumb mb-20">
                            <a href="course-details"><img class="img-fluid" src="assets/img/course/15.jpg" alt=""></a>
                            <div class="heart-icon"><i class="fas fa-heart"></i></div>
                            <div class="research-tag">
                                <span>Research</span>
                                <span>Tag</span>
                ...
                <div class="col-lg-4 col-md-6 grid-item cat1">
                    <div class="z-gallery z-gallery-two gallery-03 mb-30">
                        <div class="z-gallery__thumb mb-20">
                            <a href="course-details"><img class="img-fluid" src="assets/img/course/16.jpg" alt=""></a>
                            <div class="heart-icon"><i class="fas fa-heart"></i></div>
                            <div class="research-tag">
                                <span>Research</span>
                                <span>Tag</span>
                ...
                <div class="col-lg-4 col-md-6 grid-item cat3">
                    <div class="z-gallery z-gallery-two gallery-03 mb-30">
                        <div class="z-gallery__thumb mb-20">
                            <a href="course-details"><img class="img-fluid" src="assets/img/course/17.jpg" alt=""></a>
                            <div class="heart-icon"><i class="fas fa-heart"></i></div>
                            <div class="research-tag">
                                <span>Research</span>
                                <span>Tag</span>
                ...
                <div class="col-lg-4 col-md-6 grid-item cat2 cat1">
                    <div class="z-gallery z-gallery-two gallery-03 mb-30">
                        <div class="z-gallery__thumb mb-20">
                            <a href="course-details"><img class="img-fluid" src="assets/img/course/18.jpg" alt=""></a>
                            <div class="heart-icon"><i class="fas fa-heart"></i></div>
                            <div class="research-tag">
                                <span>Research</span>
                                <span>Tag</span>
                ...
                <div class="row align-items-center mb-50">
                    <div class="col-xl-5 col-lg-12">
                        <div class="chose-wrapper mb-30">
                            ...
                            <a href="about" class="theme_btn wow fadeInUp2 animated" data-wow-delay='.5s'>More Details</a>
                        </div>
                    </div>
                ...
                <div class="instructor-active owl-carousel">
                    <div class="item">
                        <div class="z-instructors z-instructors-02 text-center mb-30">
                            ...
                            <div class="z-instructors__content">
                                <h3 class="semi-title mb-20"><a href="instructor-profile">Kevin Petersen</a></h3>
                    ...
                    <div class="item">
                        <div class="z-instructors z-instructors-02 text-center mb-30">
                            ...
                            <div class="z-instructors__content">
                                <h3 class="semi-title mb-20"><a href="instructor-profile">Mally Yan</a></h3>
                                 <p>15+ Courses <span>15+ Courses</span></p>
                                <div class="social-media">
                                    <a href="#"><i class="fab fa-facebook-f"></i></a>
                                    <a href="#"><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="item">
                        <div class="z-instructors z-instructors-02 text-center mb-30">
                            ...
                            <div class="z-instructors__content">
                                <h3 class="semi-title mb-20"><a href="instructor-profile">Mesud Lamb</a></h3>
                                 <p>15+ Courses <span>15+ Courses</span></p>
                                <div class="social-media">
                                    <a href="#"><i class="fab fa-facebook-f"></i></a>
                                    <a href="#"><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="item">
                        <div class="z-instructors z-instructors-02 text-center mb-30">
                            ...
                            <div class="z-instructors__content">
                                <h3 class="semi-title mb-20"><a href="instructor-profile">Havana Lyon</a></h3>
                                 <p>15+ Courses <span>15+ Courses</span></p>
                                <div class="social-media">
                                    <a href="#"><i class="fab fa-facebook-f"></i></a>
                                    <a href="#"><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="item">
                        <div class="z-instructors z-instructors-02 text-center mb-30">
                            ...
                            <div class="z-instructors__content">
                                <h3 class="semi-title mb-20"><a href="instructor-profile">John Zlathan</a></h3>
                                <p>15+ Courses <span>15+ Courses</span></p>
                                <div class="social-media">
                                    <a href="#"><i class="fab fa-facebook-f"></i></a>
                                    <a href="#"><i class="fab fa-twitter"></i></a>
            ...
            <div class="container custom-container-testimonial">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-6 col-lg-4 text-center text-lg-end">
                        <a href="blog-details" class="theme_btn">Read All Reviews</a>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="z-blogs z-blogs-3 mb-30 wow fadeInUp2 animated" data-wow-delay='.1s'>
                                <div class="z-blogs__thumb mb-25">
                                    <a href="blog-details"><img src="assets/img/blog/07.jpg" alt="blog-img"></a>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="z-blogs z-blogs-3 mb-30 wow fadeInUp2 animated" data-wow-delay='.2s'>
                                <div class="z-blogs__thumb mb-25">
                                    <a href="blog-details"><img src="assets/img/blog/08.jpg" alt="blog-img"></a>
                                </div>
                                <div class="z-blogs__content">
                                    <div class="blog__tags mb-20">
                                        <span>Business</span>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="z-blogs z-blogs-3 mb-30 wow fadeInUp2 animated" data-wow-delay='.3s'>
                                <div class="z-blogs__thumb mb-25">
                                    <a href="blog-details"><img src="assets/img/blog/09.jpg" alt="blog-img"></a>
                                </div>
                                <div class="z-blogs__content">
                                    <div class="blog__tags mb-20">
                                        <span>Business</span>
