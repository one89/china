                   ...
                   <div class="row align-items-center">
                       <div class="col-xl-6 col-lg-6 order-last order-lg-first">
                           <div class="slider__img__box mb-50 pr-30">
                               <img class="img-one mt-55 pr-70" src="{{ URL::asset('assets/img/slider/01.png') }}" alt="">
                               <img class="slide-shape img-two" src="{{ URL::asset('assets/img/slider/02.png') }}" alt="">
                               <img class="slide-shape img-three" src="{{ URL::asset('assets/img/slider/03.png') }}" alt="">
                               <img class="slide-shape img-four" src="{{ URL::asset('assets/img/shape/dot-box-1.svg') }}" alt="">
                               <img class="slide-shape img-five" src="{{ URL::asset('assets/img/shape/dot-box-2.svg') }}" alt="">
                               <img class="slide-shape img-six" src="{{ URL::asset('assets/img/shape/zigzg-1.svg') }}" alt="">
                               <img class="slide-shape img-seven wow fadeInRight animated" data-delay="1.5s" src="{{ URL::asset('assets/img/icon/dot-plan-1.svg') }}" alt="Chose-img">
                               <img class="slide-shape img-eight" src="{{ URL::asset('assets/img/slider/earth-bg.svg') }}" alt="">
                           </div>
                       </div>
                        ...
                        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-5">
                            <div class="col">
                                <div class="single-category text-center mb-30 wow fadeInUp2 animated" data-wow-delay='.1s'>
                                    <img class="mb-30" src="{{ URL::asset('assets/img/category-icon/atom.svg') }}" alt="">
                                    <h4 class="sub-title mb-10"><a href="course-details">Science</a></h4>
                                    <p>126+ Courses Available</p>
                                </div>
                            </div>
                            <div class="col">
                                <div class="single-category text-center mb-30 wow fadeInUp2 animated" data-wow-delay='.2s'>
                                    <img class="mb-30" src="{{ URL::asset('assets/img/category-icon/web-development.svg') }}" alt="">
                                    <h4 class="sub-title mb-10"><a href="course-details">Development</a></h4>
                            ...
                            <div class="col">
                                <div class="single-category text-center mb-30 wow fadeInUp2 animated" data-wow-delay='.4s'>
                                    <img class="mb-30" src="{{ URL::asset('assets/img/category-icon/career-path.svg') }}" alt="">
                                    <h4 class="sub-title mb-10"><a href="course-details">Career</a></h4>
                                    <p>156+ Courses Available</p>
                                </div>
                            </div>
                            <div class="col">
                                <div class="single-category text-center mb-30 wow fadeInUp2 animated" data-wow-delay='.5s'>
                                    <img class="mb-30" src="{{ URL::asset('assets/img/category-icon/graphic-tool.svg') }}" alt="">
                                    <h4 class="sub-title mb-10"><a href="course-details">Arts & Design</a></h4>
            ...
            <div class="container">
                ...
                <div class="grid row">
                    ...
                    <div class="col-lg-4 col-md-6 grid-item cat2 cat3">
                        <div class="z-gallery mb-30">
                            <div class="z-gallery__thumb mb-20">
                                <a href="course-details"><img class="img-fluid" src="{{ URL::asset('assets/img/course/04.png') }}" alt=""></a>
                                <div class="feedback-tag">4.8(256)</div>
                                <div class="heart-icon"><i class="fas fa-heart"></i></div>
                            </div>
                            <div class="z-gallery__content">
                                <div class="course__tag mb-15">
                                    <span>Science</span>
                                    <span>Lab</span>
                                    <a class="f-right" href="instructor-details"><img src="{{ URL::asset('assets/img/course/in4.png') }}" alt=""></a>
                                </div>
                                <h4 class="sub-title mb-20"><a href="course-details">Take Your Career to the Next Level Future</a></h4>
                                <div class="course__meta">
                                    <span><img class="icon" src="{{ URL::asset('assets/img/icon/time.svg') }}" alt="course-meta"> 12 Class</span>
                    ...
                    <div class="col-lg-4 col-md-6 grid-item cat5 cat4">
                        <div class="z-gallery mb-30">
                            <div class="z-gallery__thumb mb-20">
                                <a href="course-details"><img class="img-fluid" src="{{ URL::asset('assets/img/course/05.png') }}" alt=""></a>
                                <div class="feedback-tag">4.8(256)</div>
                                <div class="heart-icon"><i class="fas fa-heart"></i></div>
                            </div>
                            <div class="z-gallery__content">
                                <div class="course__tag mb-15">
                                    <span>Science</span>
                                    <span>Lab</span>
                                    <a class="f-right" href="instructor-details"><img src="{{ URL::asset('assets/img/course/in5.png') }}" alt=""></a>
                                </div>
                                <h4 class="sub-title mb-20"><a href="course-details">Your Career to build for the pro level</a></h4>
                                <div class="course__meta">
                                    <span><img class="icon" src="{{ URL::asset('assets/img/icon/time.svg') }}" alt="course-meta"> 12 Class</span>
                    ...
                    <div class="col-lg-4 col-md-6 grid-item cat3 cat1">
                        <div class="z-gallery mb-30">
                            <div class="z-gallery__thumb mb-20">
                                <a href="course-details"><img class="img-fluid" src="{{ URL::asset('assets/img/course/06.png') }}" alt=""></a>
                                <div class="feedback-tag">4.8(256)</div>
                                <div class="heart-icon"><i class="fas fa-heart"></i></div>
                            </div>
                            <div class="z-gallery__content">
                                <div class="course__tag mb-15">
                                    <span>Science</span>
                                    <span>Lab</span>
                                    <a class="f-right" href="instructor-details"><img src="{{ URL::asset('assets/img/course/in6.png') }}" alt=""></a>
                                </div>
                                <h4 class="sub-title mb-20"><a href="course-details">Take A Course For You Biright Future</a></h4>
                                <div class="course__meta">
                                    <span><img class="icon" src="{{ URL::asset('assets/img/icon/time.svg') }}" alt="course-meta"> 12 Class</span>
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-7 col-lg-7">
                                <div class="chose-img-wrapper mb-50 pos-rel">
                                    ...
                                    <div class="img-bg pos-rel">
                                        <img class="chose_05 pl-70 pl-lg-0 pl-md-0 pl-xs-0" src="{{ URL::asset('assets/img/chose/05.png') }}" alt="Chose-img">
                                    </div>
                                    <img class="chose chose_06" src="{{ URL::asset('assets/img/shape/dot-box3.svg') }}" alt="Chose-img">
                                </div>
                            </div>
                            <div class="col-xl-5 col-lg-5">
                                <div class="chose-wrapper pl-25 pl-lg-0 pl-md-0 pl-xs-0">
                                    ...
                                    <a href="about" class="theme_btn wow fadeInUp2 animated" data-wow-delay='.3s'>More Details</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container custom-container-testimonial">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 text-center text-lg-end">
                        <a href="instructor" class="theme_btn">Read All Reviews</a>
                    </div>
                </div>
                        ...
                        <div class="testimonial-wrapper mb-30">
                            <div class="testimonial-authors overflow-hidden mb-15">
                                <div class="testimonial-authors__avatar">
                                      <img  src="{{ URL::asset('assets/img/testimonial/01.png') }}" alt="testi-author">
                                </div>
                    ...
                    <div class="col-xl-3">
                         <div class="item">
                            <div class="testimonial-wrapper mb-30">
                                <div class="testimonial-authors overflow-hidden mb-15">
                                    <div class="testimonial-authors__avatar">
                                        <img  src="{{ URL::asset('assets/img/testimonial/02.png') }}" alt="testi-author">
                                    </div>
                                    <div class="testimonial-authors__content mt-10">
                    ...
                    <div class="col-xl-3">
                        <div class="item">
                            <div class="testimonial-wrapper mb-30">
                                <div class="testimonial-authors overflow-hidden mb-15">
                                    <div class="testimonial-authors__avatar">
                                        <img  src="{{ URL::asset('assets/img/testimonial/03.png') }}" alt="testi-author">
                                    </div>
                                    <div class="testimonial-authors__content mt-10">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="z-blogs mb-30 wow fadeInUp2 animated" data-wow-delay='.1s'>
                                ...
                                <div class="z-blogs__content">
                                    ...
                                    <h4 class="sub-title mb-15"><a href="blog-details">5 Ways to Use Padlet in Higher -Ed Online Classroom</a></h4>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="z-blogs mb-30 wow fadeInUp2 animated" data-wow-delay='.2s'>
                                ...
                                <div class="z-blogs__content">
                                    ...
                                    <h4 class="sub-title mb-15"><a href="blog-details">4 New Zoom Features Enhance Virtual Teaching & Learning</a></h4>
                                    <div class="z-blogs__meta d-sm-flex justify-content-between pt-20">
                                        <span>Date : June 15 , 2021</span>
                                        <span>By Guest Admin</span>
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="z-blogs mb-30 wow fadeInUp2 animated" data-wow-delay='.3s'>
                                ...
                                <div class="z-blogs__content">
                                    ...
                                    <h4 class="sub-title mb-15"><a href="blog-details">Using Social Media to Support Online Teaching</a></h4>
                                    <div class="z-blogs__meta d-sm-flex justify-content-between pt-20">
                                        <span>Date : June 15 , 2021</span>
                                        <span>By Guest Admin</span>
                                    </div>
