                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="plan text-center mb-30">
                                <div class="pr__header mb-30">
                                    ...
                                    <img src="{{ URL::asset('assets/img/icon/writing.svg') }}" alt="" class="pr-icon">
                                </div>
                                <div class="pr__body">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="plan plan-2 text-center mb-30">
                                <div class="pr__header mb-30">
                                    ...
                                    <img src="{{ URL::asset('assets/img/icon/test.svg') }}" alt="" class="pr-icon">
                                </div>
                                <div class="pr__body">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="plan plan-2a text-center mb-30">
                                <div class="pr__header mb-30">
                                    ...
                                    <img src="{{ URL::asset('assets/img/icon/lifetime.svg') }}" alt="" class="pr-icon">
                                </div>
                                <div class="pr__body">
